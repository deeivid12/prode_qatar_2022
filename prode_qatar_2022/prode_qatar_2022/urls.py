...
from tournaments.views import get_rooms_list_by_user, get_room, new_tournament, new_team, new_game, get_games_list, do_pronostic, check_pronostics, get_points, get_ranking_by_room
...
urlpatterns = [
    ...
    path('all_rooms/<int:room_id>/ranking', get_ranking_by_room, name="ranking"),
